...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function fetchTransactions() {
      try {
          const response = await fetch('https://momo-analysis-bn.onrender.com/api/transactions'); 
  ...
  function renderCharts(data) {
      ...
      const monthlySummaryChart = new Chart(document.getElementById('monthlySummaryChart'), {
          type: 'line',
          data: {
      ...
      const paymentDistributionChart = new Chart(document.getElementById('paymentDistributionChart'), {
          type: 'pie',
          data: {
              labels: Object.keys(transactionTypes),
              datasets: [{
